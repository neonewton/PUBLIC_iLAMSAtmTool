...
with st.form("elentra_upload_form"):
    ...
    st.caption("Monitor URL pattern: https://ilams.lamsinternational.com/lams/monitoring/monitoring/monitorLesson.do?lessonID=")

    upload_student = st.checkbox("Upload Student URL", value=True)
    st.caption("Student URL pattern: https://ilams.lamsinternational.com/lams/home/learner.do?lessonID=")
